...
Member.create!([
  { :id => 16, :name => "Mike Mondragon", :email => "mikemondragon@gmail.com", :bio => "Ruby makes me happy.", :website => "http://plasti.cx/", :ruby_gems_id => "mikemondragon", :featured => false, :twitter => "monde", :github => "monde", :image_url => "http://a0.twimg.com/profile_images/52075135/wallace2_bigger.png", :verified => true, :password => 1234 },
  { :id => 33, :name => "Ray Lucke", :email => "ray@raylucke.com", :bio => "Ray Lucke has been a Rubyist for seven years and, when not writing software of some sort, can be found at a nearby park practicing Parkour. Favorite discussion topics also include Postgres, systems programming, and strong ales.", :website => "http://www.raylucke.com/", :ruby_gems_id => "rwl4", :featured => false, :twitter => "rwl4", :github => "rwl4", :image_url => "http://a0.twimg.com/profile_images/487086921/Shodou__Calligraphy__bigger.gif", :verified => true, :password => 1234 },
  { :id => 26, :name => "Daniel Dosen", :email => "daniel@danieldosen.org", :bio => "Ex MSer focused on Ruby/Rails/Node/Backbone/iOS development in a lean way... ", :website => "http://danieldosen.org", :ruby_gems_id => "dgdosen", :featured => false, :twitter => nil, :github => nil, :image_url => "missing_image.png", :verified => true, :password => 1234 },
  { :id => 7, :name => "Dave Myron", :email => "test@test.com", :bio => nil, :website => nil, :ruby_gems_id => "", :featured => false, :twitter => "", :github => nil, :image_url => "http://a0.twimg.com/profile_images/2224186455/me-by-sylvia_bigger.jpg", :verified => true, :password => 1234 },
  { :id => 17, :name => "Phil Hagelberg", :email => "phil@hagelb.org", :bio => "", :website => "http://technomancy.us", :ruby_gems_id => "technomancy", :featured => false, :twitter => "technomancy", :github => nil, :image_url => "http://a0.twimg.com/profile_images/1808933337/_bigger.face", :verified => true, :password => 1234 },
  { :id => 22, :name => "Wilson Bilkovich", :email => "test2@test.com", :bio => "Honorary Member", :website => "http://metaclass.org", :ruby_gems_id => "wilson", :featured => false, :twitter => "defiler", :github => nil, :image_url => "http://a0.twimg.com/profile_images/1819188466/profile_headshot_small_bigger.jpg", :verified => true, :password => 1234 },
  { :id => 23, :name => "Alex Vollmer", :email => "alex.vollmer@gmail.com", :bio => nil, :website => "http://livollmers.net", :ruby_gems_id => "avollmer", :featured => false, :twitter => "alexvollmer", :github => nil, :image_url => "http://a0.twimg.com/profile_images/1502622955/Photo_on_8-15-11_at_3.55_PM_bigger.jpg", :verified => true, :password => 1234 },
  { :id => 25, :name => "Geoffrey Grosenbach", :email => "boss@topfunky.com", :bio => nil, :website => "http://nubyonrails.com", :ruby_gems_id => "topfunky", :featured => false, :twitter => "topfunky", :github => nil, :image_url => "http://a0.twimg.com/profile_images/1416014432/mask_avatar_fin_v2-300x300_bigger.jpg", :verified => true, :password => 1234 },
  { :id => 9, :name => "Eric Hodel", :email => "drbrain@segment7.net", :bio => "Eric Hodel is a Ruby committer and maintainer of RubyGems, RDoc, mechanize and many other ruby libraries.  He also commits documentation from the documenting-ruby.org project.  In his spare time he looks at the stars and plays video games.\r\n", :website => "http://segment7.net", :ruby_gems_id => "drbrain", :featured => false, :twitter => "drbrain", :github => "", :image_url => "http://a0.twimg.com/profile_images/793861173/58479f76374a3ba3c69b9804163f39f4_bigger.jpeg", :verified => true, :password => 1234 },
  { :id => 27, :name => "Pete Higgins", :email => "pete@peterhiggins.org", :bio => "I'm a full-time professional ruby developer and a part-time amateur rubyist. I live in seattle and I like ruby, linux and lowercase.", :website => "http://beginrescue.blogspot.com", :ruby_gems_id => "phiggy", :featured => false, :twitter => "pete_higgins", :github => "phiggins", :image_url => "http://a0.twimg.com/profile_images/1342144110/me_and_bunny_cropped_bigger.jpeg", :verified => true, :password => 1234 },
  { :id => 11, :name => "Evan Phoenix", :email => "evan@fallingsnow.net", :bio => "Ex-member and founder of _very_ south-seattle.rb. Author of rubinius.", :website => "http://blog.fallingsnow.net", :ruby_gems_id => "evan", :featured => false, :twitter => "evanphx", :github => "", :image_url => "http://a0.twimg.com/profile_images/1266966931/eightbit-e0e50a3c-888e-4ec7-9395-bc783777b145_bigger.png", :verified => true, :password => 1234 },
  { :id => 31, :name => "Ben Bleything", :email => "ben@bleything.net", :bio => "Co-founder and organizer of Cascadia Ruby.", :website => "http://bleything.net/", :ruby_gems_id => "bleything", :featured => false, :twitter => "bleything", :github => "bleything", :image_url => "http://a0.twimg.com/profile_images/1260090298/foo_bigger.png", :verified => true, :password => 1234 },
...
Suggestion.create!([
  { :id => 1, :title => "Setting up rdoc for all of the libraries in my project.", :suggester => nil, :comment => "" },
  { :id => 2, :title => "Someone should show us how Real Rubyists should do RubyGems the Right Way! Packaging, versioning, signing, maybe even with Hoe?", :suggester => nil, :comment => "" },
  { :id => 4, :title => "rspec/capybara how-to/101 lesson", :suggester => nil, :comment => "" },
  { :id => 5, :title => "Critique my code - show your code on the projector and have others offer their input and discussion", :suggester => nil, :comment => "" }
])
