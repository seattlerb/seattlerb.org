...
Member.create!([
  ...
  { :id => 7, :name => "Dave Myron", :email => nil, :bio => nil, :website => nil, :ruby_gems_id => "orangechicken", :twitter => "orngchkn", :github => nil, :image_url => "http://a0.twimg.com/profile_images/2224186455/me-by-sylvia_bigger.jpg", :verified => true },
  ...
  { :id => 22, :name => "Wilson Bilkovich", :email => nil, :bio => "Honorary Member", :website => "http://metaclass.org", :ruby_gems_id => "wilson", :twitter => "defiler", :github => nil, :image_url => "http://a0.twimg.com/profile_images/1819188466/profile_headshot_small_bigger.jpg", :verified => true },
