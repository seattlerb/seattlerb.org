...
Member.create!([
  { :id => 16, :name => "Mike Mondragon", :email => "mikemondragon@gmail.com", :bio => "Ruby makes me happy.", :website => "http://plasti.cx/", :ruby_gems_id => "mikemondragon", :featured => false, :twitter => "monde", :github => "https://github.com/monde", :image_url => "http://a0.twimg.com/profile_images/52075135/wallace2_bigger.png" },
  ...
  { :id => 7, :name => "Dave Myron", :email => nil, :bio => nil, :website => nil, :ruby_gems_id => "orangechicken", :featured => false, :twitter => "orngchkn", :github => nil, :image_url => "http://a0.twimg.com/profile_images/2224186455/me-by-sylvia_bigger.jpg" },
  { :id => 17, :name => "Phil Hagelberg", :email => "phil@hagelb.org", :bio => "", :website => "http://technomancy.us", :ruby_gems_id => "technomancy", :featured => false, :twitter => "technomancy", :github => nil, :image_url => "http://a0.twimg.com/profile_images/1808933337/_bigger.face" },
  { :id => 22, :name => "Wilson Bilkovich", :email => nil, :bio => "Honorary Member", :website => "http://metaclass.org", :ruby_gems_id => "wilson", :featured => false, :twitter => "defiler", :github => nil, :image_url => "http://a0.twimg.com/profile_images/1819188466/profile_headshot_small_bigger.jpg" },
  { :id => 23, :name => "Alex Vollmer", :email => "alex.vollmer@gmail.com", :bio => nil, :website => "http://livollmers.net", :ruby_gems_id => "avollmer", :featured => false, :twitter => "alexvollmer", :github => nil, :image_url => "http://a0.twimg.com/profile_images/1502622955/Photo_on_8-15-11_at_3.55_PM_bigger.jpg" },
  { :id => 25, :name => "Geoffrey Grosenbach", :email => "boss@topfunky.com", :bio => nil, :website => "http://nubyonrails.com", :ruby_gems_id => "topfunky", :featured => false, :twitter => "topfunky", :github => nil, :image_url => "http://a0.twimg.com/profile_images/1416014432/mask_avatar_fin_v2-300x300_bigger.jpg" },
  { :id => 9, :name => "Eric Hodel", :email => "drbrain@segment7.net", :bio => "Eric Hodel is a Ruby committer and maintainer of RubyGems, RDoc, mechanize and many other ruby libraries.  He also commits documentation from the documenting-ruby.org project.  In his spare time he looks at the stars and plays video games.\r\n", :website => "http://segment7.net", :ruby_gems_id => "drbrain", :featured => false, :twitter => "drbrain", :github => "", :image_url => "http://a0.twimg.com/profile_images/793861173/58479f76374a3ba3c69b9804163f39f4_bigger.jpeg" },
  { :id => 27, :name => "Pete Higgins", :email => "pete@peterhiggins.org", :bio => "I'm a full-time professional ruby developer and a part-time amateur rubyist. I live in seattle and I like ruby, linux and lowercase.", :website => "http://beginrescue.blogspot.com", :ruby_gems_id => "phiggy", :featured => false, :twitter => "pete_higgins", :github => "https://github.com/phiggins", :image_url => "http://a0.twimg.com/profile_images/1342144110/me_and_bunny_cropped_bigger.jpeg" },
