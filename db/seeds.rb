...
Member.create!([
  ...
  { :id => 31, :name => "Ben Bleything", :email => "ben@bleything.net", :bio => "Co-founder and organizer of Cascadia Ruby.", :website => "http://bleything.net/", :ruby_gems_id => "bleything", :featured => false, :twitter => "bleything", :github => "https://github.com/bleything", :image_url => "http://a0.twimg.com/profile_images/1260090298/foo_bigger.png", :verified => true },
