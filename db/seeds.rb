...
Admin.create!([{ :id => 3, :email => "admin@mailinator.com", :password => "asdfasdf", :password_confirmation => "asdfasdf"}])

Member.create!([
  { :id => 16, :name => "Mike Mondragon", :email => "mikemondragon@gmail.com", :bio => "Ruby makes me happy.", :website => "http://plasti.cx/", :ruby_gems_id => "mikemondragon", :twitter => "monde", :github => "monde", :image_url => "http://a0.twimg.com/profile_images/52075135/wallace2_bigger.png", :verified => true },
  { :id => 33, :name => "Ray Lucke", :email => "ray@raylucke.com", :bio => "Ray Lucke has been a Rubyist for seven years and, when not writing software of some sort, can be found at a nearby park practicing Parkour. Favorite discussion topics also include Postgres, systems programming, and strong ales.", :website => "http://www.raylucke.com/", :ruby_gems_id => "rwl4", :twitter => "rwl4", :github => "rwl4", :image_url => "http://a0.twimg.com/profile_images/487086921/Shodou__Calligraphy__bigger.gif", :verified => true },
  { :id => 26, :name => "Daniel Dosen", :email => "daniel@danieldosen.org", :bio => "Ex MSer focused on Ruby/Rails/Node/Backbone/iOS development in a lean way... ", :website => "http://danieldosen.org", :ruby_gems_id => "dgdosen", :twitter => nil, :github => nil, :image_url => "missing_image.png", :verified => true },
  { :id => 7, :name => "Dave Myron", :email => "", :bio => nil, :website => nil, :twitter => "orngchkn", :github => nil, :image_url => "http://a0.twimg.com/profile_images/2224186455/me-by-sylvia_bigger.jpg", :verified => true },
  { :id => 17, :name => "Phil Hagelberg", :email => "phil@hagelb.org", :bio => "", :website => "http://technomancy.us", :ruby_gems_id => "technomancy", :twitter => "technomancy", :github => nil, :image_url => "http://a0.twimg.com/profile_images/1808933337/_bigger.face", :verified => true },
  { :id => 22, :name => "Wilson Bilkovich", :email => "", :bio => "Honorary Member", :website => "http://metaclass.org", :ruby_gems_id => "wilson", :twitter => "defiler", :github => nil, :image_url => "http://a0.twimg.com/profile_images/1819188466/profile_headshot_small_bigger.jpg", :verified => true },
  { :id => 23, :name => "Alex Vollmer", :email => "alex.vollmer@gmail.com", :bio => nil, :website => "http://livollmers.net", :ruby_gems_id => "avollmer", :twitter => "alexvollmer", :github => nil, :image_url => "http://a0.twimg.com/profile_images/1502622955/Photo_on_8-15-11_at_3.55_PM_bigger.jpg", :verified => true },
  { :id => 25, :name => "Geoffrey Grosenbach", :email => "boss@topfunky.com", :bio => nil, :website => "http://nubyonrails.com", :ruby_gems_id => "topfunky", :twitter => "topfunky", :github => nil, :image_url => "http://a0.twimg.com/profile_images/1416014432/mask_avatar_fin_v2-300x300_bigger.jpg", :verified => true },
  { :id => 9, :name => "Eric Hodel", :email => "drbrain@segment7.net", :bio => "Eric Hodel is a Ruby committer and maintainer of RubyGems, RDoc, mechanize and many other ruby libraries.  He also commits documentation from the documenting-ruby.org project.  In his spare time he looks at the stars and plays video games.\r\n", :website => "http://segment7.net", :ruby_gems_id => "drbrain", :twitter => "drbrain", :github => "", :image_url => "http://a0.twimg.com/profile_images/793861173/58479f76374a3ba3c69b9804163f39f4_bigger.jpeg", :verified => true },
  { :id => 27, :name => "Pete Higgins", :email => "pete@peterhiggins.org", :bio => "I'm a full-time professional ruby developer and a part-time amateur rubyist. I live in seattle and I like ruby, linux and lowercase.", :website => "http://beginrescue.blogspot.com", :ruby_gems_id => "phiggy", :twitter => "pete_higgins", :github => "phiggins", :image_url => "http://a0.twimg.com/profile_images/1342144110/me_and_bunny_cropped_bigger.jpeg", :verified => true },
  { :id => 11, :name => "Evan Phoenix", :email => "evan@fallingsnow.net", :bio => "Ex-member and founder of _very_ south-seattle.rb. Author of rubinius.", :website => "http://blog.fallingsnow.net", :ruby_gems_id => "evan", :twitter => "evanphx", :github => "", :image_url => "http://a0.twimg.com/profile_images/1266966931/eightbit-e0e50a3c-888e-4ec7-9395-bc783777b145_bigger.png", :verified => true },
  { :id => 31, :name => "Ben Bleything", :email => "ben@bleything.net", :bio => "Co-founder and organizer of Cascadia Ruby.", :website => "http://bleything.net/", :ruby_gems_id => "bleything", :twitter => "bleything", :github => "bleything", :image_url => "http://a0.twimg.com/profile_images/1260090298/foo_bigger.png", :verified => true },
  { :id => 1, :name => "Aaron Patterson", :email => "aaron.patterson@gmail.com", :bio => "Aaron Patterson fell in love with Seattle and Ruby in 2001. He’s worked for ATT, Classmates.com, and Vehix.com and has contributed Ruby open source projects such as the popular Nokogiri. Aaron also loves blogging about his latest adventures in coding and meat products.", :website => "http://tenderlovemaking.com", :ruby_gems_id => "tenderlove", :twitter => "tenderlove", :github => "", :image_url => "http://a0.twimg.com/profile_images/1261953917/headshot_bigger.png", :verified => true },
  { :id => 32, :name => "Dean Hudson", :email => "dean@ero.com", :bio => "Dean is interested in art, data visualization, emerging technology, and making games for the open web. He currently works at Massively Fun as a game developer, and is an MCDM Fellow at the University of Washington.", :website => "http://www.hdh.me/", :ruby_gems_id => "deanh", :twitter => "deanero", :github => "deanh", :image_url => "http://a0.twimg.com/profile_images/1782133369/image1327565249_bigger.png", :verified => true },
  { :id => 29, :name => "Aja Hammerly", :email => "aja.hammerly@gmail.com", :bio => "Aja loves writing ruby. She's passionate about education technology and giant piles of data. She'd like to learn more about data mining and data visualization.", :website => "http://www.thagomizer.com/", :ruby_gems_id => "kushali", :twitter => "kushali", :github => "kushali", :image_url => "http://a0.twimg.com/profile_images/2341090480/paxi5por0exmux647gic_bigger.jpeg", :verified => true },
  { :id => 20, :name => "Ryan Davis", :email => "ryand-ruby@zenspider.com", :bio => "Ryan Davis has been using Ruby since 2000; his background includes QA, automation, language and tool development, object databases, and smalltalk in ruby/rails. He has worked on developer productivity and test automation tools such as heckle, hoe, ruby_parser, ruby2c, ruby2ruby, rubyinline, zentest, minitest, and many more. Additionally, he’s a loving cat foster parent, a culinary enthusiast, and a proud geoduck.", :website => "http://zenspider.com", :ruby_gems_id => "zenspider", :twitter => "", :github => "", :image_url => "http://www.zenspider.com/~ryan/bio_pic_small.jpeg", :verified => true },
  { :id => 34, :name => "Daniel Azuma", :email => "dazuma@gmail.com", :bio => "Daniel Azuma has been using Ruby since 2005, and has a particular interest in geospatial programming with Ruby and Rails. In his spare time, he studies theology, bicycles around western Washington, and imitates cats.", :website => "http://daniel-azuma.com/", :ruby_gems_id => "dazuma", :twitter => "danielazuma", :github => "dazuma", :image_url => "http://a0.twimg.com/profile_images/2158354760/gravatar_small_bigger.png", :verified => true },
  { :id => 30, :name => "Mike Tierney", :email => "mike@panpainter.com", :bio => "Michael is an illustrator and UI designer/developer, working primarily with Ruby. He likes to create things that make other people's lives more enjoyable. His free time is spent playing video games, painting, and maintaining a handful of ruby gems like csspool and artii.", :website => "http://miketierney.com/", :ruby_gems_id => "panpainter", :twitter => "miketierney", :github => "miketierney", :image_url => "http://a0.twimg.com/profile_images/1555485292/mike-and-zeb_bigger.png", :verified => true },
  { :id => 35, :name => "Ivan Stork", :email => "ivan@sustainablemarketing.com", :bio => "", :website => "", :ruby_gems_id => "ivanoats", :twitter => "ivanoats", :github => "ivanoats", :image_url => "http://a0.twimg.com/profile_images/2987698956/c3ffa2792cb597647f2ca3db7f461c4d_bigger.jpeg", :verified => true }
])
